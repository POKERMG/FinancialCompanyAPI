...
from request_for_quote_action import RequestForQuoteAction
from settings import B2C2_BASE_URL, BUY_COMMAND, SELL_COMMAND, API_TOKEN


def _parse_args(args):
    parser = argparse.ArgumentParser(description='Trader Client for B2C2')
    parser.add_argument('BTCUSD.SPOT',
                        required=True,
                        type=str,
